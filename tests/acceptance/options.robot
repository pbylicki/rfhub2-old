...
Help for option --root
    [Documentation]    Verify that the help message includes help for --root
...
Help for option -l/--library
    [Documentation]    Verify that the help message includes help for -i/--interface
    Start the hub with options    --help
    Output should contain
...
Help for option -no-installed-keywords
    [Documentation]    Verify that the help message includes help for --no-installed-keywords
    Start the hub with options    --help
    Output should contain
...
Help for option -M/--module
    [Documentation]    Verify that the help message includes help for -M/--module
    Start the hub with options    --help
    Output should contain 
...
Help for option --poll
    [Documentation]    Verify that the help message includes help for --poll
    Start the hub with options    --help
    Output should contain
    ...    --poll
