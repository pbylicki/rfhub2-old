...
*** Test Cases ***
Base URL 
    [Documentation]    Objective: verify base url returns a page
    [Tags]    smoke
    Go to    ${ROOT}/doc
...
Search via search box redirects to /doc/keywords
    [Documentation]    Objective: search via the search box and verify that the correct page is loaded
    [Tags]    smoke
    Go to    ${ROOT}/doc
...
Keyword search URL goes to search page
    [Documentation]    Objective: verify that the keyword search URL works
    [Tags]    smoke
    Go to    ${ROOT}/doc
    Search for    none shall pass
    Page should contain    Searching for 'none shall pass' found 1 keywords
...
Using the name: prefix
    [Documentation]    Objective: verify the name: prefix works
    Go to    ${ROOT}/doc
    Search for    name:screenshot
    Page should contain    Searching for 'screenshot' found 6 keywords

Using the in: prefix
    [Documentation]    Objective: verify the in: prefix works
    Go to    ${ROOT}/doc
